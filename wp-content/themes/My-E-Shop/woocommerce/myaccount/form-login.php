<?php
/**
 * Login / Register form (My-E-Shop theme override)
 *
 * Keeps all WooCommerce fields, hooks and nonces — only markup/classes are
...
<div class="account-auth <?php echo $has_registration ? 'account-auth--split' : ''; ?>" id="customer_login">

	<div class="account-auth__col account-auth__login">
	...
	<div class="account-auth__col account-auth__register">
