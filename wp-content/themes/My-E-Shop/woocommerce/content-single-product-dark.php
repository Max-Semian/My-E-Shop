    ...
    <div class="product-layout">
        ...
        <div class="product-info-section">
            <div class="product-dark-content">
                ...
                <?php
                // Do not show custom selects for variable products
                ...
                <!-- Add to cart form -->
                <?php if ( $product->is_type( 'variable' ) ) : ?>
                    <!-- Hidden standard WooCommerce variations form for functionality -->
                    <div style="display: none;">
                        <?php woocommerce_variable_add_to_cart(); ?>
                    </div>

                    <!-- Custom form with quantity and add to cart for variable products -->
                ...
                <?php else : ?>
                    <!-- Use a custom form for simple products -->
