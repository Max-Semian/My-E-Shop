/**
 * Single Product Light Theme JavaScript
 * Handles carousel, wishlist, variations, accordion and reviews
 */
...
jQuery(document).ready(function($) {
    ...
    if (wishlist.indexOf(productId) > -1) {
        $('.add-to-favorite-btn-light').addClass('favorited');
        $('.add-to-favorite-btn-light svg').attr('fill', '#ff6b9d');
        $('.add-to-favorite-btn-light path').attr('fill', '#ff6b9d');
    }
    
    // Add to favorite functionality
    $('.add-to-favorite-btn-light').on('click', function(e) {
        var button = $(this);
        var wishlist = getWishlist();
